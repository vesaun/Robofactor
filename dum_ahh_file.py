...
def my_function(
    arg1, arg2
):  # E225: missing whitespace around operator, E251: unexpected spaces around keyword / parameter equals
    ...
    a_very_long_variable_name_just_to_make_this_line_exceed_the_limit_for_testing = (
        arg1 + arg2
    )
...
class MyClass:  # C0114: Missing module docstring, C0116: Missing class docstring
    ...
    def another_method(
        self, x, y
    ):  # C0116: Missing function docstring, E225: missing whitespace around operator
